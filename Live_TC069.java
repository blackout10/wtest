...
public class Live_TC069 {
	...
	public void TC069() throws Exception {
		try {
			...
			// 장바구니 버튼 기다림
			wait = new WebDriverWait(driver, waitTime);
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='frmContent']/div/div[3]/a[2]/img")));
			System.out.println("장바구니 버튼 기다림");
			
			// 장바구니 버튼 클릭
			driver.findElement(By.xpath(".//*[@id='frmContent']/div/div[3]/a[2]/img")).click(); 
